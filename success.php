...
$sql = mysqli_query($conn, "SELECT Pro_total FROM `inovice` WHERE inovice_id='".$item_number."'");
					...
					<div class="container-fluid">
						...
						<div class="card mb-4 ">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-center">Payment Status</h6>
							</div>
							<div class="card-body">
								<h4><? if($item_price==$price && $item_currency==$currency)
								{
									echo "Payment Successful";
									mysqli_query($conn, "INSERT INTO payment(invoice_id,status) VALUES('" . $item_number . "','1')");
